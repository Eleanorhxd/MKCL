...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='D:\ehr\code\R2GenCMN-main\data\iu_xray\images',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=r'D:\ehr\code\R2GenCMN-main\data\iu_xray\annotation.json',
                        help='the path to the directory containing the data.')
    parser.add_argument('--vocab-path', type=str, default=r'D:\ehr\code\R2GenCMN-main\data\vocab.pkl')
    ...
    parser.add_argument('--save_dir', type=str, default=r'D:\ehr\code\R2GenCMN-main\results\iu_xray', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default=r'D:\ehr\code\R2GenCMN-main\records', help='the patch to save the results of experiments.')
...
def main():
    ...
    embs = read_word_embeddings(r"D:\ehr\code\R2GenCMN-main\data\embedding\glove.6B.200d-relativized.txt")
    #print(embs.vectors)
    ...
    trainer = Trainer(model, fw_adj, bw_adj, criterion, criterion_c, metrics, optimizer, args, lr_scheduler, train_dataloader, val_dataloader, test_dataloader) #criterion_c, fw_adj, bw_adj,
