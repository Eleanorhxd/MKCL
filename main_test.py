...
def parse_agrs():
    ...
    parser.add_argument('--load', type=str, default=r'D:\ehr\code\R2GenCMN-main\results\iu_xray\model_best.pth', help='whether to load the pre-trained model.')
...
def main():
    ...
    with open(r'D:\ehr\code\R2GenCMN-main\data\openi_matrix_40nodes_binary.txt', 'r') as matrix_file:
